...
class Pagination
{
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li ><a class="page-link" href="/'.$page.'">'.$text.'</a></li>';
    }
    ...
    private function amount() {
        if (($this->total / $this->limit) == intval($this->total / $this->limit)) {
            return ceil(intval($this->total / $this->limit)) - 1;
        }
        return ceil(intval($this->total / $this->limit));
    }
}
